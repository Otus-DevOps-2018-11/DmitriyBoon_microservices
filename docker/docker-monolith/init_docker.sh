...
echo 'BUILD'
docker build -t dmitriyboon/post:1.0 ../src/post-py
docker build -t dmitriyboon/comment:1.0 ../src/comment
docker build -t dmitriyboon/ui:1.0 ../src/ui

echo 'PULL'
docker push dmitriyboon/post:1.0
docker push dmitriyboon/comment:1.0
docker push dmitriyboon/ui:1.0
